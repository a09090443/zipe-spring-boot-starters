...
Web 頁面 + REST API（web-starter）、Spring Security 表單登入（logon-starter）、多資料來源切換（db-starter）、Quartz 排程（job-starter）、CXF WebService（web-service-starter）、加解密 / 郵件 / HTTP 工具（base-starter）。
