...
import com.zipe.config.QuartzDataStoreConfig;
...
@ConditionalOnResource(resources = {"classpath:/quartz-data-source.properties"})
@Import(QuartzDataStoreConfig.class)
public class QuartzDataStoreAutoConfiguration {
	...
	@Bean
	public PlatformTransactionManager quartzTransactionManager(EntityManagerFactory entityManagerFactory) {
