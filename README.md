...
| 模組 | 版本 | 說明 |
|------|------|------|
| [base-spring-boot-starter](base-spring-boot-starter/README.md) | 3.5.7.0 | 基礎工具（加解密、文件、郵件等） |
| [db-spring-boot-starter](db-spring-boot-starter/README.md) | 3.5.7.0 | 動態多資料來源切換 |
| [job-spring-boot-starter](job-spring-boot-starter/README.md) | 3.5.7.0 | Quartz 排程任務管理 |
| [logon-spring-boot-starter](logon-spring-boot-starter/README.md) | 3.5.7.0 | Spring Security 登入認證 |
| [web-spring-boot-starter](web-spring-boot-starter/README.md) | 3.5.7.0 | JSP / Thymeleaf 視圖整合 |
| [web-service-spring-boot-starter](web-service-spring-boot-starter/README.md) | 3.5.7.0 | Apache CXF SOAP WebService |
